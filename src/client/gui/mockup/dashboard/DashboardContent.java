...
import client.gui.pages.dashboard.prototype.HumanBeingCommandBar;
import client.gui.pages.dashboard.prototype.HumanBeingTablePanel;
import client.gui.pages.dashboard.prototype.HumanBeingVisualizationPanel;
...
public class DashboardContent extends BorderPane {
    ...
    private final client.gui.pages.dashboard.prototype.HumanBeingTablePanel tablePanel;
    private final client.gui.pages.dashboard.prototype.HumanBeingVisualizationPanel visualizationPanel = new HumanBeingVisualizationPanel();
    private final client.gui.pages.dashboard.prototype.HumanBeingCommandBar commandBar = new HumanBeingCommandBar();
    ...
    private client.gui.pages.dashboard.prototype.DashboardSection currentSection = client.gui.pages.dashboard.prototype.DashboardSection.COLLECTION;
    ...
    public DashboardContent(String currentUser, Lab7CommandGateway gateway) {
        ...
        showSection(client.gui.pages.dashboard.prototype.DashboardSection.COLLECTION);
    }
    ...
    public void showSection(client.gui.pages.dashboard.prototype.DashboardSection section) {
