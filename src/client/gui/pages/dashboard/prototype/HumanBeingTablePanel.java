...
/**
 * Table panel for displaying HumanBeing objects.
 * Contains: filter input, action buttons, data table.
 *
 * Note: This is an internal component of PrototypePage.
 * Logic (filter/sort) is kept here for simplicity,
 * but could be extracted to a controller if needed.
 */
public class HumanBeingTablePanel extends UiCard {
    ...
    private void configureControls() {
        ...
        resetButton.setOnAction(e -> {
            ...
            setStatus(Messages.get(Messages.Key.STATUS_FILTER_RESET));
        });
    ...
    private void configureTableColumns() {
        table.addColumn(new ColumnSpec<>("id", HumanBeingUiModel::id, 60,
                        Comparator.comparingLong(HumanBeingUiModel::id)))
                .addColumn(new ColumnSpec<>("name", HumanBeingUiModel::name, 115,
