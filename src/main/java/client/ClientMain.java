    ...
    public static void main(String[] args) {
        ...
        scheduler.scheduleAtFixedRate(() -> {
            ...
            if (!isSocketAlive(socket)) {
                System.out.println("\nDisconnected to main.java.server, start reconnecting ...");
                isConnected = false;
        ...
        while (true) {
            ...
            if (!isConnected) {
                log("❌ Connecting error: Server is not response. (If main.java.server is not running, start main.java.server first!)");
            } else {
                try {
    ...
    public static boolean reconnect() {
        try {
            ...
            if (firstRes.getStatusCode() != StatusCode.SERVICE_UNAVAILABLE) {
                ...
                log("✅ Connected to main.java.server successfully!");
                ...
                log(firstRes.getMessage());
                Terminal.startAnimation("Reconnecting to main.java.server...");
                return false;
            }
        } catch (Exception e) {
            return false;
...
//
//        scheduler.scheduleAtFixedRate(() -> {
//            if (isReconnecting) return; // prevent call when cli is trying to reconnect to main.java.server
...
//            }
//        } catch (IOException e) {
//            log("❌ Failed to reconnect to the main.java.server!");
//            return false;
//        } catch (Exception e) {
...
////
////            ReconnectingEffectManager.stopEffect();
////            ReconnectingEffectManager.startEffect("Reconnecting to main.java.server...");
...
////                    System.out.println("📩 Server response:\n" + resp.getMessage());
////                } catch (IOException e) {
////                    System.err.println("❌ Connecting error: Server is not response. (If main.java.server is not running, start main.java.server first!)");
////                }
////            }